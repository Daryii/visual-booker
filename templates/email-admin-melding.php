  ...
  <table width="500" cellpadding="0" cellspacing="0">
    <tr>
      <td style="background:#e8e8e8;padding:20px;">
        <h2 style="margin:0;">Nieuwe boeking ontvangen</h2>
      </td>
    </tr>
    ...
    <tr>
      <td style="padding:20px;">
        ...
        <p>
          Naam: <?php echo esc_html( $customer_name ); ?><br>
          E-mail: <?php echo esc_html( $customer_email ); ?><br>
          Telefoon: <?php echo esc_html( $customer_phone ?: '—' ); ?><br>
          Notities: <?php echo esc_html( $notes ?: '—' ); ?>
        </p>
        ...
        <p>Beheer boekingen via WP Admin → Booking Layouts.</p>
      </td>
    </tr>
